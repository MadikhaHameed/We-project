			...
			<div class="col s12 m4">
				<div class="card">
				    ...
				    <div class="card-content">
				      ...
				      <div class="card-content">
			          <p>This is a popular Food of Pakistan. Order Now to Grab a bite of it!</p>
			        </div>
			        <div class="card-content center">
			          <a href="backends/order-food.php?id=<?php echo $arr_all[$i+$j-2]['id']; ?>" style="background: #5ae99a;" class="btn waves-effect waves-block waves-light" href="">Order Now!</a>
			        </div>
				    </div>
